...
public class asmParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'/'", "'$'", "'('", "')'", "'*'", "':'", "'+'", "','", "'-'", 
		"ASSEMBLER_DIRECTIVE", "REGISTER", "OPCODE", "NAME", "NUMBER", "COMMENT", 
		"STRING", "EOL", "WS"
	};
	public static final int
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 2) | (1L << 3) | (1L << ASSEMBLER_DIRECTIVE) | (1L << REGISTER) | (1L << OPCODE) | (1L << NAME) | (1L << NUMBER) | (1L << COMMENT) | (1L << STRING) | (1L << EOL))) != 0) );
			}
		}
	...
	public final InstructionContext instruction() throws RecognitionException {
		...
		try {
			...
			setState(56);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 2) | (1L << 3) | (1L << REGISTER) | (1L << NAME) | (1L << NUMBER) | (1L << STRING))) != 0)) {
				{
				setState(55); expressionlist();
				}
			}
	...
	public static class Register_Context extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof asmListener ) ((asmListener)listener).enterRegister_(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof asmListener ) ((asmListener)listener).exitRegister_(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof asmVisitor ) return ((asmVisitor<? extends T>)visitor).visitRegister_(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final DirectiveContext directive() throws RecognitionException {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 2) | (1L << 3) | (1L << REGISTER) | (1L << NAME) | (1L << NUMBER) | (1L << STRING))) != 0)) {
				{
				setState(62); argument();
				}
			}

			setState(65); assemblerdirective();
			setState(66); expressionlist();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class AssemblerdirectiveContext extends ParserRuleContext {
		public TerminalNode ASSEMBLER_DIRECTIVE() { return getToken(asmParser.ASSEMBLER_DIRECTIVE, 0); }
	...
	public final AssemblerdirectiveContext assemblerdirective() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(68); match(ASSEMBLER_DIRECTIVE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class LblContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof asmListener ) ((asmListener)listener).enterLbl(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof asmListener ) ((asmListener)listener).exitLbl(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof asmVisitor ) return ((asmVisitor<? extends T>)visitor).visitLbl(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExpressionlistContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof asmListener ) ((asmListener)listener).enterExpressionlist(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof asmListener ) ((asmListener)listener).exitExpressionlist(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof asmVisitor ) return ((asmVisitor<? extends T>)visitor).visitExpressionlist(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(84); multiplyingExpression();
			setState(89);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==7 || _la==9) {
				...
				consume();
				setState(86); multiplyingExpression();
				}
				}
				setState(91);
				_errHandler.sync(this);
	...
	public static class ArgumentContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof asmListener ) ((asmListener)listener).enterArgument(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof asmListener ) ((asmListener)listener).exitArgument(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof asmVisitor ) return ((asmVisitor<? extends T>)visitor).visitArgument(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DollarContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof asmListener ) ((asmListener)listener).enterDollar(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof asmListener ) ((asmListener)listener).exitDollar(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof asmVisitor ) return ((asmVisitor<? extends T>)visitor).visitDollar(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StringContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof asmListener ) ((asmListener)listener).enterString(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof asmListener ) ((asmListener)listener).exitString(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof asmVisitor ) return ((asmVisitor<? extends T>)visitor).visitString(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\n\f\16\20\22\24\26\30\32\34\36 \"$\2\4\4\2\t\t\13\13\4\2\3\3\7\7z\2*"+
		"\3\2\2\2\4/\3\2\2\2\68\3\2\2\2\b<\3\2\2\2\n>\3\2\2\2\fA\3\2\2\2\16F\3"+
		"\2\2\2\20H\3\2\2\2\22L\3\2\2\2\24T\3\2\2\2\26V\3\2\2\2\30^\3\2\2\2\32"+
		"o\3\2\2\2\34q\3\2\2\2\36s\3\2\2\2 u\3\2\2\2\"w\3\2\2\2$y\3\2\2\2&(\5\4"+
		...
		"\13\2IK\7\b\2\2JI\3\2\2\2JK\3\2\2\2K\21\3\2\2\2LQ\5\26\f\2MN\7\n\2\2N"+
		"P\5\26\f\2OM\3\2\2\2PS\3\2\2\2QO\3\2\2\2QR\3\2\2\2R\23\3\2\2\2SQ\3\2\2"+
		"\2TU\5 \21\2U\25\3\2\2\2V[\5\30\r\2WX\t\2\2\2XZ\5\30\r\2YW\3\2\2\2Z]\3"+
		"\2\2\2[Y\3\2\2\2[\\\3\2\2\2\\\27\3\2\2\2][\3\2\2\2^c\5\32\16\2_`\t\3\2"+
		"\2`b\5\32\16\2a_\3\2\2\2be\3\2\2\2ca\3\2\2\2cd\3\2\2\2d\31\3\2\2\2ec\3"+
		"\2\2\2fp\5\"\22\2gp\5\n\6\2hp\5\34\17\2ip\5 \21\2jp\5\36\20\2kl\7\5\2"+
		"\2lm\5\26\f\2mn\7\6\2\2np\3\2\2\2of\3\2\2\2og\3\2\2\2oh\3\2\2\2oi\3\2"+
		"\2\2oj\3\2\2\2ok\3\2\2\2p\33\3\2\2\2qr\7\4\2\2r\35\3\2\2\2st\7\22\2\2"+
		"t\37\3\2\2\2uv\7\17\2\2v!\3\2\2\2wx\7\20\2\2x#\3\2\2\2yz\7\21\2\2z%\3"+
		"\2\2\2\16\',/\63\66:AJQ[co";
